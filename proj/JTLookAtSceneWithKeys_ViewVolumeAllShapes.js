...
var g_EyePosX = 7.2; g_EyePosY = 1; g_EyePosZ = 4.25;
...
//  console.log('myMouseUp: xMdragTot,yMdragTot =',xMdragTot,',\t',yMdragTot);
  ...
  // console.log("Eye position x == " + g_EyeX);
  // console.log("Eye position y == " + g_EyeY);
  // console.log("Eye position z == " + g_EyeZ);


  // console.log("Eye Look at x == " + g_EyePosX);
  // console.log("Eye Look at y == " + g_EyePosY);
...
if(timesLogged < 2){
  ...
  */
  ...
  myModelMatrix.translate(0,1.3,7);
  myModelMatrix.rotate(currentAngle,0,0,1);
  myGL.uniformMatrix4fv(myu_ModelMatrix,false,myModelMatrix.elements);
  passNormals(myModelMatrix);
...
function passNormals(myModelMatrix){
