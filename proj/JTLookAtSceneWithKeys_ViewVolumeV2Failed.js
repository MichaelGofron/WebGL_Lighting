...
//==============================================================================
  ...
  */
  ...
  mySiz = gndVerts.length + cubeVerts.length;
...
viewMatrix.rotate(-90.0, 1,0,0); // new one has "+z points upwards",
  ...
  pushMatrix(viewMatrix); // full body
  ...
  pushMatrix(viewMatrix); // right leg
  viewMatrix.translate(0.4,0,-1.2);
  viewMatrix.scale(0.3,0.6,0.5);
  myGL.uniformMatrix4fv(u_ViewMatrix,false,viewMatrix.elements);
  myGL.drawArrays(myGL.TRIANGLES,
                  robotRightLegStart/floatsPerVertex,
                  cubeVertsToDraw/floatsPerVertex);
  viewMatrix = popMatrix(); // right leg

  pushMatrix(viewMatrix); // left leg
  viewMatrix.translate(-0.4,0,-1.2);
  viewMatrix.scale(0.3,0.6,0.5);
  myGL.uniformMatrix4fv(u_ViewMatrix,false,viewMatrix.elements);
  myGL.drawArrays(myGL.TRIANGLES,
  ...
  pushMatrix(viewMatrix); // left arm
  viewMatrix.translate(-1.4,0,0);
  viewMatrix.scale(0.4,0.7,0.7);
  myGL.uniformMatrix4fv(u_ViewMatrix,false,viewMatrix.elements);
  myGL.drawArrays(myGL.TRIANGLES,
  ...
  pushMatrix(viewMatrix); // right arm shoulder
  viewMatrix.translate(1.2,0,0.4);
  ...
  pushMatrix(viewMatrix); // right arm 
  viewMatrix.translate(3.0,0,-1.4);
  viewMatrix.scale(2.0,2.6,2.6);
  viewMatrix.rotate(currentAngle,0,1,0);
  myGL.uniformMatrix4fv(u_ViewMatrix,false,viewMatrix.elements);
  myGL.drawArrays(myGL.TRIANGLES,
  ...
  viewMatrix = popMatrix(); // right arm 
  viewMatrix = popMatrix(); // right arm shoulder

  viewMatrix = popMatrix(); // full body


  viewMatrix.translate(10.0,0,0.0);
